...
public class GCPaymentTrans implements GTransaction{
    @Override
    public UnitGCPaymentTrans newTransaction() {
        UnitGCPaymentTrans loObject = new UnitGCPaymentTrans();
    ...
    @Override
    public UnitGCPaymentTrans loadTransaction(String string) {
        UnitGCPaymentTrans loObject = new UnitGCPaymentTrans();
    ...
    @Override
    public UnitGCPaymentTrans saveUpdate(Object o, String string) {
        String lsSQL = "";
        UnitGCPaymentTrans loOldEnt = null;
        UnitGCPaymentTrans loNewEnt = null;
        UnitGCPaymentTrans loResult = null;
        
        // Check for the value of foEntity
        if (!(o instanceof UnitGCPaymentTrans)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitGCPaymentTrans) o;
        
        // Test if entry is ok
        if (loNewEnt.getCompnyCd()== null || loNewEnt.getCompnyCd().isEmpty()){
            setMessage("Invalid company detected.");
            return loResult;
        }
        
        if (loNewEnt.getValidity()== null){
            setMessage("Invalid date transact detected.");
            return loResult;
        }
        
        if (loNewEnt.getReferNox()== null || loNewEnt.getReferNox().isEmpty()){
            setMessage("Invalid refrence number detected.");
            return loResult;
        }
        
        if (loNewEnt.getAmountxx()== null){
            setMessage("Invalid GC amount detected.");
            return loResult;
        }
        
        if (loNewEnt.getAmtPaidx()== null){
            setMessage("Invalid amount paid detected.");
            return loResult;
        }
    ...
    public String getSQ_Master() {
        return (MiscUtil.makeSelect(new UnitGCPaymentTrans()));
    }
