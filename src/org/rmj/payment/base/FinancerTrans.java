...
public class FinancerTrans implements GTransaction{
    @Override
    public UnitFinancerTrans newTransaction() {
        UnitFinancerTrans loObject = new UnitFinancerTrans();
    ...
    @Override
    public UnitFinancerTrans loadTransaction(String string) {
        UnitFinancerTrans loObject = new UnitFinancerTrans();
    ...
    public UnitFinancerTrans loadTransaction(String fsSourceNo, String fsSourceCd) {
        UnitFinancerTrans loObject = new UnitFinancerTrans();
    ...
    @Override
    public UnitFinancerTrans saveUpdate(Object o, String string) {
        String lsSQL = "";
        UnitFinancerTrans loOldEnt = null;
        UnitFinancerTrans loNewEnt = null;
        UnitFinancerTrans loResult = null;
        
        // Check for the value of foEntity
        if (!(o instanceof UnitFinancerTrans)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitFinancerTrans) o;
        
        // Test if entry is ok
        if (loNewEnt.getFinancer()== null || loNewEnt.getFinancer().isEmpty()){
            setMessage("Invalid financer detected.");
            return loResult;
        }
        ...
        System.out.println(loNewEnt.getTable());
    ...
    public String getSQ_Master() {
        return (MiscUtil.makeSelect(new UnitFinancerTrans()));
    }
