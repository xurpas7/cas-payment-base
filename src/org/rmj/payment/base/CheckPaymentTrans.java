...
public class CheckPaymentTrans implements GTransaction{
    @Override
    public UnitCheckPaymentTrans newTransaction() {
        UnitCheckPaymentTrans loObject = new UnitCheckPaymentTrans();
    ...
    @Override
    public UnitCheckPaymentTrans loadTransaction(String string) {
        UnitCheckPaymentTrans loObject = new UnitCheckPaymentTrans();
    ...
    public UnitCheckPaymentTrans loadTransaction(String fsSourceNo, String fsSourceCd) {
        UnitCheckPaymentTrans loObject = new UnitCheckPaymentTrans();
    ...
    @Override
    public UnitCheckPaymentTrans saveUpdate(Object o, String string) {
        String lsSQL = "";
        UnitCheckPaymentTrans loOldEnt = null;
        UnitCheckPaymentTrans loNewEnt = null;
        UnitCheckPaymentTrans loResult = null;
        
        // Check for the value of foEntity
        if (!(o instanceof UnitCheckPaymentTrans)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitCheckPaymentTrans) o;
        ...
        if (loNewEnt.getCheckNox()== null || loNewEnt.getCheckNox().isEmpty()){
            setMessage("Invalid check number detected.");
            return loResult;
        }
        
        if (loNewEnt.getCheckDte()== null){
            setMessage("Invalid date detected.");
            return loResult;
        }
    ...
    public String getSQ_Master() {
        return (MiscUtil.makeSelect(new UnitCheckPaymentTrans()));
    }
