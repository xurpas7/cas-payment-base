...
public class SalesPayment implements GTransaction{
    @Override
    public UnitSalesPayment newTransaction() {
        UnitSalesPayment loObject = new UnitSalesPayment();
    ...
    @Override
    public UnitSalesPayment loadTransaction(String string) {
        UnitSalesPayment loObject = new UnitSalesPayment();
    ...
    @Override
    public UnitSalesPayment saveUpdate(Object o, String string) {
        String lsSQL = "";
        UnitSalesPayment loOldEnt = null;
        UnitSalesPayment loNewEnt = null;
        UnitSalesPayment loResult = null;
        
        // Check for the value of foEntity
        if (!(o instanceof UnitSalesPayment)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitSalesPayment) o;
    ...
    public String getSQ_Master() {
        return (MiscUtil.makeSelect(new UnitSalesPayment()));
    }
