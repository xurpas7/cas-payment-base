...
public class ORMaster implements GTransaction{
    @Override
    public UnitReceiptMaster newTransaction() {
        UnitReceiptMaster loObject = new UnitReceiptMaster();
    ...
    @Override
    public UnitReceiptMaster loadTransaction(String string) {
        UnitReceiptMaster loObject = new UnitReceiptMaster();
    ...
    @Override
    public UnitReceiptMaster saveUpdate(Object o, String string) {
        String lsSQL = "";
        UnitReceiptMaster loOldEnt = null;
        UnitReceiptMaster loNewEnt = null;
        UnitReceiptMaster loResult = null;
        
        // Check for the value of foEntity
        if (!(o instanceof UnitReceiptMaster)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitReceiptMaster) o;
        
        
        // Test if entry is ok
        if (loNewEnt.getInvNmber()== null || loNewEnt.getInvNmber().isEmpty()){
            setMessage("Invalid Official Receipt number detected.");
            return loResult;
        }        
    ...
    public String getSQ_Master() {
        return MiscUtil.addCondition(MiscUtil.makeSelect(new UnitReceiptMaster()),
